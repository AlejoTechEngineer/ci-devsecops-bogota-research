...
[![Enfoque](https://img.shields.io/badge/Enfoque-Investigación%20cuantitativa-3776AB.svg)]()
[![Formato](https://img.shields.io/badge/Referencias-APA%207ª%20edición-150458.svg)]()
[![Gestor](https://img.shields.io/badge/Gestor%20bibliográfico-Mendeley-EF4035.svg?logo=mendeley&logoColor=white)]()
...
<img src="https://img.shields.io/badge/Dominio-Integración%20Continua%20%26%20DevSecOps-blue?style=flat-square" alt="Dominio"/>
<img src="https://img.shields.io/badge/Ámbito-Empresas%20de%20software%20·%20Bogotá%20D.C.-green?style=flat-square" alt="Ámbito"/>
<img src="https://img.shields.io/badge/Tipo-Ensayo%20académico-red?style=flat-square" alt="Tipo"/>
<img src="https://img.shields.io/badge/Fuentes-6%20verificadas-lightgrey?style=flat-square" alt="Fuentes"/>
...
![Mendeley](https://img.shields.io/badge/Mendeley-gestión%20bibliográfica-EF4035?style=for-the-badge&logo=mendeley&logoColor=white)
![Mendeley Cite](https://img.shields.io/badge/Mendeley%20Cite-complemento%20Word-EF4035?style=for-the-badge)
...
![APA 7](https://img.shields.io/badge/APA-7ª%20edición-150458?style=for-the-badge)
...
```mermaid
flowchart TD
    A[Introducción] --> B[Desarrollo Del Laboratorio]
    B --> C[Parte I - Idea De Investigación]
    C --> D[Parte II - Cuadro De Análisis]
    D --> E[Parte III - Uso Del Citador Mendeley]
    E --> F[Parte IV - Justificación]
    F --> G[Conclusiones]
    G --> H[Bibliografía APA 7]
    H --> I[Agradecimiento]
```
...
```mermaid
flowchart LR
    P["Tema - Adopcion de CI y DevSecOps"] --> Q["Idea de investigacion - Enfoque cuantitativo"]
    Q --> R["Objeto de estudio - Empresas de software de Bogota D.C."]
    R --> S["Cuadro de analisis - Descomposicion metodologica"]
    S --> T["Fuentes verificadas - 3 academicas + 3 oficiales"]
    T --> U["Justificacion - Pertinencia y relevancia"]
    U --> V["Conclusiones y referencias APA 7"]
```
